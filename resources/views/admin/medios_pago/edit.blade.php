...
<div class="max-w-xl mx-auto py-8">
    ...
    <form action="{{ route('metodos-pago.update', $metodoPago) }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        @method('PUT')

        <div class="mb-4">
            <label for="nombre" class="block text-gray-700 text-sm font-bold mb-2">Nombre del Método de Pago:</label>
            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $metodoPago->nombre) }}"
